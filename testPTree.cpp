...
TEST_CASE("PTree::2x2FlipHori", "[weight=1][part=ptree]") {
   ...
   cout << tree.GetRoot()->A->upperleft.first << endl;
   cout << tree.GetRoot()->A->upperleft.second << endl;
   cout << tree.GetRoot()->B->upperleft.first << endl;
   cout << tree.GetRoot()->B->upperleft.second << endl;
   tree.FlipHorizontal();
   cout << tree.GetRoot()->A->upperleft.first << endl;
   cout << tree.GetRoot()->A->upperleft.second << endl;
   cout << tree.GetRoot()->B->upperleft.first << endl;
